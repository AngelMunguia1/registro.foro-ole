...
html;
        View::set('header',$extraHeader);
        View::set('footer',$extraFooter);
        View::render("encuesta_hematologia");
    }
...
html;
        View::set('header',$extraHeader);
        View::set('footer',$extraFooter);
        View::render("encuesta_oncologia");
    }
    ...
    public function saveEncuestaHema(){
        ...
        if($user){
           ...
           // echo "no existe";
            ...
            $id = EncuestasDao::insertHema($data);
    ...
    public function saveEncuestaOnco(){
        ...
        if($user){
           ...
           // echo "no existe";
            ...
            $id = EncuestasDao::insertOnco($data);
