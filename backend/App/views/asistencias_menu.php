<?php echo $header; ?>
<title>
    Asistencias - FORO OLE - GRUPO LAHE
</title>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="d-flex flex-column h-100">
                                            <h4 class="m-4">Sistema de asistencias, por favor, selecciona una opción<br><strong>FORO OLE 2022</strong></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
