...
class Encuestas
{
  ...
  public static function insertOnco($datos)
  {
    $mysqli = Database::getInstance(1);
    $query = <<<sql
    INSERT INTO encuesta (nombre, email, foro,preg_1, preg_2, preg_3, preg_3_txt, preg_4, preg_5_1,preg_5_2,preg_5_3,preg_5_4,preg_5_5,preg_5_6,preg_5_7,preg_5_8,preg_5_9,preg_5_10,preg_5_11,preg_5_12,preg_5_13,preg_5_14,preg_5_15,preg_6, preg_8, 
    preg_8_1, preg_9, preg_10) 
    VALUES (:nombre, :email, :foro,:preg_1, :preg_2, :preg_3 , :preg_3_txt, :preg_4, :preg_5_1, :preg_5_2, :preg_5_3, :preg_5_4, :preg_5_5, :preg_5_6, :preg_5_7, :preg_5_8,:preg_5_9, :preg_5_10, :preg_5_11, :preg_5_12, :preg_5_13, :preg_5_14, :preg_5_15,:preg_6, :preg_8, 
    :preg_8_1, :preg_9, :preg_10);
sql;
  ...
  public static function insertHema($datos)
  {
    $mysqli = Database::getInstance(1);
    $query = <<<sql
  INSERT INTO encuesta (nombre, email, foro,preg_1, preg_2, preg_3, preg_3_txt, preg_4, preg_5_1,preg_5_2,preg_5_3,preg_5_4,preg_5_5,preg_5_6,preg_5_7,preg_6, preg_8, 
  preg_8_1, preg_9, preg_10) 
  VALUES (:nombre, :email, :foro,:preg_1, :preg_2, :preg_3 , :preg_3_txt, :preg_4, :preg_5_1, :preg_5_2, :preg_5_3, :preg_5_4, :preg_5_5, :preg_5_6, :preg_5_7, :preg_6, :preg_8, 
  :preg_8_1, :preg_9, :preg_10);
sql;
